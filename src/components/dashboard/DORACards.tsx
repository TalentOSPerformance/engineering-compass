...
const doraMetrics: DORAMetric[] = [
  { title: "Deployment Frequency", value: "4.2", unit: "deploys/day", level: "elite", trend: "up", trendValue: "+12%" },
  { title: "Lead Time for Changes", value: "2.1", unit: "hours", level: "high", trend: "down", trendValue: "-8%" },
